...
<div class="sl-sideleft">
  ...
  <div class="sl-sideleft-menu">
        ...
        <a href="{{ url('/') }}" class="sl-menu-link @yield('category')">
            <div class="sl-menu-item">
                <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i>
                <span class="menu-item-label">go web-site</span>
            </div><!-- menu-item -->
            </a><!-- sl-menu-link -->
        ...
        <a href="{{ url('subcategories') }}" class="sl-menu-link @yield('subcategory')">
            <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i>
        ...
        <a href="{{ url('/product/list') }}" class="sl-menu-link @yield('product')">
            <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i>
      ...
      <div class="dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-header wd-200">
          <ul class="list-unstyled user-profile-nav">
            <li><a href="{{ url('/edit/editprofile') }}"><i class="icon ion-ios-person-outline"></i> Edit Profile</a></li>
