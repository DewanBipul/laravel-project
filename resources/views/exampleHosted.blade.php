        ...
        <div class="col-md-8 m-auto">
            ...
            <form action="{{ url('/pay') }}" method="POST" class="needs-validation">
                ...
                <div class="row">
                    ...
                    <input type="hidden" value="{{ session('total_from_cart')-session('discount_from_cart') }}" name="final_total">
                    ...
                    <div class="col-lg-12 ">
                        ...
                        <ul class="list-group mb-3">
                            ...
                            <li class="list-group-item d-flex justify-content-between">
                                <span>Total (BDT)</span>
                                <strong>{{ session('total_from_cart')- session('discount_from_cart') }}</strong>
                            </li>
                        </ul>
                    </div>
            ...
            <footer class="my-5 m-auto text-muted text-center text-small">
