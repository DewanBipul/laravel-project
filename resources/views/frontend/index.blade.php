                    ...
                    <div class="featured-wrap">
                        <div class="featured-img">
                            ...
                            <div class="featured-content">
                                <a href="{{ url('/category/product')}}/{{ $product->id }}">{{  $product->product_name }}</a>
                            </div>
                        </div>
                    </div>
                    @endforeach
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body d-flex">
                                ...
                                <div class="product-single-content w-50">
                                    ...
                                    <ul class="cetagory">
                                        <li>Categories:</li>
                                        <li><a href="#">{{ $product->relation_to_category_has_one->category_name }}</a></li>
