                        ...
                        <nav class="mainmenu">
                            <ul class="d-flex">
                                ...
                                <li>
                                    ...
                                    <ul class="dropdown_style">
                                        <li><a href="{{ url('/shopproduct') }}">Shop Page</a></li>
                        ...
                        <ul class="search-cart-wrapper d-flex">
                            ...
                            <li>
                                ...
                                <ul class="cart-wrap dropdown_style">
                                    ...
                                    @foreach (App\Models\cart::where('random_genarated_cart_id', Cookie::get('random_genarated_cart_id'))->get() as $cart_product)

                                    <li class="cart-items">
                                        <div class="cart-img">
                                            <img width="60" src="{{asset('/uploads/product')}}/{{App\Models\product::find($cart_product->product_id)->product_photo}}" alt="">
                                        </div>
                                        <div class="cart-content">
                                            ...
                                            <p>{{ App\Models\product::find($cart_product->product_id)->product_price * $cart_product->product_quantity }}</p>
                                           <a href="{{url('/delete/cart') }}/{{ $cart_product->id }}"> <i class="fa fa-times"></i></a>
                                        </div>
                                    </li>

                                    @php
                                    $subtotal= $subtotal+(App\Models\product::find($cart_product->product_id)->product_price * $cart_product->product_quantity);
                                    ...
                                    <li>
                                        ...
                                        <a class="btn btn-success" href="{{ url('/cart') }}">Check Out</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
